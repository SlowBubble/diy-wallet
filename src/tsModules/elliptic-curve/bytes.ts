...
// export function bigIntToLittleEndianBytes(bigInt: bigint, numberOfBytes: number = 0): Bytes {
//   const bytes: Bytes = [];
//   while (bigInt > 0) {
...
// export function intToLittleEndianBytes(int: number, numberOfBytes: number = 0): Bytes {
